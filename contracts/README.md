...
| 2026-09-05 | (no impl change) | **Ownership transferred** — contract `owner` + beacon owner set to `0x3f1a683418dba4c38dd853a7b896f7327a9fef9f` (previously `0xB831…CEd7`). No implementation change. |
